...
function cargarProductosCarrito(){
   if (productosEnCarrito && productosEnCarrito.length >0){
      ...
      productosEnCarrito.forEach(producto => {
         ...
         div.innerHTML = `
                    <img  class="carrito-producto-imagen img-fluid" src="${producto.imagen}" alt="${productos.titulo}">
...
function eliminarDelCarrito(e) {
    ...
    productosEnCarrito.splice(productos, 1);
    cargarProductosCarrito();
...
// botonComprar.addEventListener("click", function(event){ //funcion anonima, que se utiliza solamente una vez en un componente
